...
export default function Events({ onNavigate }: { onNavigate: (s: Screen) => void }) {
 ...
 <header className="w-full sticky top-0 z-50 bg-zinc-300/70 backdrop-blur-xl flex items-center justify-center px-6 pt-14 pb-4 border-b border-zinc-400/30">
  <img 
    src="/logo.png" 
    alt="Kyrios Logo" 
